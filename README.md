...
<p align="center">
  <img src="./首页图片.png" alt="魔法3P 游戏首页" width="720" />
</p>

### 运行效果

<p align="center">
  <img src="./运行.png" alt="魔法3P 运行效果" />
</p>
...
- 牌型大小：**豹子 > 同花顺 > 金花 > 顺子 > 对子 > 散牌**（注意：本游戏 金花 > 顺子）
- 顺子 QKA 最大、A23 最小
- 闲家与庄家的牌型和比较点数完全相同时，庄家胜
- 闲家只和庄家比；庄家胜率 ≥ 70%（不四舍五入）即过关
- 庄家开满至少 70% 的闲家牌后，若本轮未过关且余牌充足，可提前点击「继续发牌」进入下一轮；未开的闲家仍计入本轮胜率
